...
from griffin.plugins.switcher.utils import shorten_paths

# Local imports
from griffin_notebook.config import CONF_DEFAULTS, CONF_VERSION
from griffin_notebook.confpage import NotebookConfigPage
...
class NotebookPlugin(GriffinDockablePlugin):
    ...
    def get_description():
        ...
        return _("Work with Jupyter notebooks inside Griffin.")
