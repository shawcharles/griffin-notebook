...
from griffin_notebook.widgets.notebooktabwidget import (
...
def tabwidget(mocker, qtbot):
    ...
    mocker.patch(
        'griffin_notebook.widgets.notebooktabwidget.WAIT_SAVE_DELAY', 1)
...
def test_save_notebook_with_empty_new_notebook(mocker, tabwidget):
    ...
    mock_question = mocker.patch(
        'griffin_notebook.widgets.notebooktabwidget.QMessageBox.question')
...
def test_wait_and_check_if_empty_when_empty(mocker, tabwidget):
    ...
    mock_read = mocker.patch(
        'griffin_notebook.widgets.notebooktabwidget.nbformat.read',
