...
# Copied from conftest.py in main Griffin repo, with one change in
...
from griffin.app.cli_options import get_options
...
class MainWindowMock(QMainWindow):
    ...
    def __init__(self, parent):
        ...
        from griffin.plugins.preferences.plugin import Preferences
...
class ConfigDialogTester(QWidget):
    def __init__(self, parent, main_class,
        ...
        def register_plugin(self, plugin_name, external=False):
            ...
            # in _instantiate_griffin5_plugin() so no need to go so here
