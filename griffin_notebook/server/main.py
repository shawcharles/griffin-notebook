...
"""Entry point for server rendering notebooks for Griffin."""
...
aliases['info-file'] = 'GriffinNotebookApp.info_file_cmdline'

flags['dark'] = (
    {'GriffinNotebookApp': {'dark_theme': True}},
    'Use dark theme when rendering notebooks'
)


class GriffinNotebookHandler(NotebookBaseHandler):
    """A notebook page handler for Griffin."""
...
class GriffinNotebookApp(JupyterNotebookApp):
    """The Griffin notebook server extension app."""

    name = 'griffin_notebook'
    file_url_prefix = "/griffin-notebooks"
    ...
    def initialize_handlers(self):
        """Initialize handlers."""
        self.handlers.append(('/griffin-notebooks(.*)', GriffinNotebookHandler))
...
main = GriffinNotebookApp.launch_instance
