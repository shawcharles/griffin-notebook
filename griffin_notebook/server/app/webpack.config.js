...
// Notebook, except where indicated by comments containing "Griffin:"
...
const extras = Build.ensureAssets({
  packageNames: names,
  output: buildDir,
  schemaOutput: path.resolve(__dirname, '..')  // Griffin: change path
});
...
module.exports = [
  merge(baseConfig, {
    ...
    output: {
      path: path.resolve(__dirname, '..', 'static/'),  // Griffin: change path
      library: {
        type: 'var',
    ...
    plugins: [
      new WPPlugin.JSONLicenseWebpackPlugin({
        excludedPackageTest: (packageName) =>
          packageName === '@griffin-notebook/app',  // Griffin: change name
      }),
