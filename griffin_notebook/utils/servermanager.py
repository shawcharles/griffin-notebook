...
# Griffin imports
from griffin.config.base import DEV, get_home_dir, get_module_path


# Kernel specification to use in notebook server
KERNELSPEC = 'griffin.plugins.ipythonconsole.utils.kernelspec.GriffinKernelSpec'
...
class ServerManager(QObject):
    ...
    def start_server(self, filename, interpreter):
        ...
        arguments = ['-m', 'griffin_notebook.server', '--no-browser',
        ...
        if DEV:
            ...
            env.insert('PYTHONPATH', osp.dirname(get_module_path('griffin')))
